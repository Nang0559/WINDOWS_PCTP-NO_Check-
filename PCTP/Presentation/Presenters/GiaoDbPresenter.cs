...
namespace PCTP.Presentation.Presenters
{
    internal sealed class GiaoDbPresenter : IDisposable
    {
        ...
        private void OnLuuGiaoDB(object sender, EventArgs e) => _c.RunWithLoadingSync(() => { _c.PhieuSvc.LuuGiaoDB(_c.PhieuView.GetDonHangTable(), _c.GioXuatHienTai, _c.AddNM); _v.ShowInfo("Xong !!!"); }, "Đang lưu dữ liệu giao DB...");
