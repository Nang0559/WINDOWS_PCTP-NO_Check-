...
namespace PCTP.QRCODE_HVN.PGH.Controls
{
    public sealed class PhieuBottomStateControl : XtraUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridCTTGL.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            GridVTTGL});
            // 
            // GridVTTGL
            // 
            GridVTTGL.ActiveFilterEnabled = false;
            GridVTTGL.Bands.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.GridBand[] {
            gridBand1});
            GridVTTGL.Columns.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn[] {
            gridColumn4,
            gridColumn5,
            gridColumn6});
            ...
            // gridBand1
            // 
            gridBand1.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(128)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
            ...
            gridCtrSUASL.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            gridVSUASL});
            // 
            // gridVSUASL
            // 
            ...
            gridCLECH.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            bandedGridViewLECH});
            gridCLECH.Visible = false;
            // 
            // bandedGridViewLECH
            // 
            bandedGridViewLECH.Bands.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.GridBand[] {
            gridBandLECH});
            bandedGridViewLECH.Columns.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn[] {
            colLechMaHang,
            colLechTenHang,
            colLechSoLuong,
            colLechNguon});
            ...
            // 
            Controls.Add(gridCLECH); Controls.Add(gridCTTGL); Controls.Add(gridCtrSUASL);
