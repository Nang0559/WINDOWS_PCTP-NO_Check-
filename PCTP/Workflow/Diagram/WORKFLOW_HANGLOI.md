...
graph TD
    ...
    B1["IKhachTraHangService<br/>Nguon: Khach Hang"]
    B2["ITraNoiBoService<br/>Nguon: Noi Bo"]
    ...
    %% ====================================================
    SlotForm["FormChonSlotNoiBo<br/>Tao phieu Noi Bo tu Slot LOT"]
    ...
    Rework2 --> Step5["IQTChungService.GhiNhanGiaoSanXuat<br/>InsertGiao<br/>Khong dung Slot va STOCKTP<br/>Status: DaGiaoSanXuat"]
    ...
    QtyCheck -->|SoLuongNG lon hon 0| Step8["IReworkStockService.NhapLaiHangNG<br/>OK: Cong lai ton<br/>NG: Route vao Slot NG<br/>InsertNhapNG"]
